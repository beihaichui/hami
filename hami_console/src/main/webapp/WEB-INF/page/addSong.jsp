        ...
        function submitFile() {
            ...
            $('#song-form').ajaxSubmit({
                ...
                success:function (json) {
                    //$("#songera").attr("href",json.realPath);
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <form data-validate="parsley" method="post" novalidate="" action="/song/add" class="form-horizontal label-left" id="song-form">
                                ...
                                <fieldset>
                                    ...
                                    <%--<div class="control-group">--%>
           <%--&lt;%&ndash;@declare id="mtype"&ndash;%&gt;<label for="mtype" class="control-label">图片<span class="required">*</span></label>--%>
                                        <%--<div class="controls form-group">--%>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input type="file" name="mp3file" id='i1-file'  accept=".mp3" onchange="submitFile()" style="display: none">
                                ...
                                <div class="form-actions text-right">
                                    <button class="btn btn-primary" id="songSubmit" type="submit">提交歌曲</button>
                                </div>
                                </form>
                            </div>
                        </div>
