...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            ...
            <form method="post" id="txForm" action="/songer/dofindAll" class="form-horizontal" >
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="icon-music"></i></span>
                                                <input type="text" placeholder="如：黄家驹" name="srname" value="${songer.srname}" id="srname" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="icon-user"></i></span>
                                                <input type="text" placeholder="如：香港" name="area" value="${songer.area}" id="area" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <select id="tid"  name="tid" class="form-control ">
                                                ...
                                                <c:forEach items="${mtypes}" var="mtype">
                                                    <option value="${mtype.tid}" <c:if test="${mtype.tid == songer.tid}">selected</c:if>>${mtype.tname}</option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <table class="table table-striped table-images" style="color: white;font-size: 14px">
                                        ...
                                        <c:forEach items="${page.list}" var="songer">
                                            <tr>
                                                ...
                                                <td><button class="btn btn-sm btn-primary" modify srid="${songer.srid}"> 修改 </button>
