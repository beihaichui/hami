...
<head>
    ...
    <script>
        $(function () {
            $("#songer").addClass("current");
            $("#songerSubmit").click(function () {
                $('#user-form').submit();
            })
        });
        function submitFile() {
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <form data-validate="parsley" action="/songer/add" method="post" novalidate="" class="form-horizontal label-left" id="user-form" />
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="col-sm-4 col-md-2">
                                                <div class="image-row">
                                                    <div class="image-set">
                                                        <a id="songera" class="example-image-link" href="../../img/gallery-photo/image-3.jpg" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
                                ...
                                <div class="form-actions text-right">
                                    <button id="songerSubmit" class="btn btn-primary" type="submit">提交艺人</button>
                                </div>
                                </form>
                            </div>
                        </div>
