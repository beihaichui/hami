...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            ...
            <form id="txForm" method="post" action="/song/dofindAll" class="form-horizontal" >
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="icon-music"></i></span>
                                                <input type="text" placeholder="如：想你的365天"  value="${song.sname}" name="sname" id="sname" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="icon-user"></i></span>
                                                <input type="text" placeholder="如：李玟" value="${song.srname}" name="srname" id="srname" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="icon-reorder"></i></span>
                                                <input type="text" placeholder="如：宝莲灯" value="${song.aname}" name="aname" id="aname" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped table-images" style="color: white;font-size: 14px">
                                        ...
                                        <c:forEach items="${page.list}" var="song">
                                            <tr>
                                                ...
                                                <td><button id="update" class="btn btn-sm btn-primary" modify type="button" sid="${song.sid}"> 修改 </button>
