    ...
    <script>
        ...
        $(function () {
            ...
            $(".filter p a").click(function () {
                ...
                window.location.href = "/protal/search.do?tid=" + tid + "&isHot=" + isHot + "&isNew=" + isNew;
            })
        ...
        function loadMore() {
            ...
            window.location.href = "/protal/search.do?tid=" + tid + "&isHot=" + isHot + "&isNew=" + isNew + "&pageSize=" + pageSize + "&pageNoPortal=" + pageNoPortal;
        }
...
<div id="body" class="gap">
    ...
    <div class="wrapper">
        ...
        <div class="sidebar" data-spm="1392350021">
            ...
            <div class="genre">
                <c:forEach items="${mtypes}" var="mtype">
                    <a href="/protal/search.do?tid=${mtype.tid}"><b></b>${mtype.tname}</a>
                </c:forEach>
            </div>
        </div>
    </div>
