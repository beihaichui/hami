...
<head>
    ...
    <meta name="description" content="${songer.srname}好听的歌:时间煮雨,指望,问明月,听你说,暖心,时光正好,好朋友只是朋友,原谅不美好等;${songer.srname}最新歌曲在线免费试听,尽在虾米音乐！"/>
                ...
                <table>
                    <tr>
                        ...
                        <td class="subnav">
                            ...
                            <a class="bigtext middle current" href="http://i.xiami.com">音乐人</a>
                            <script>
                        ...
                        <div id="artist_info">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td valign="top"><a href="/songer/list?tid="${songer.mtype.tid}>
                                ...
                                <c:forEach items="${songer.songs}" var="song" varStatus="status">
                                    <c:if test="${song.sid != null}">
                                        <tr data-needpay="1" data-playstatus="1" data-downloadstatus="2"
                                            data-json="">
                                            <td class="chkbox"><input type="checkbox" checked="checked" value="${song.sid}"
                                                                      name="recommendids"/></td>
